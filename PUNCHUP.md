...
To make sure this feature would be responsive it would most likely be scaled up or down (as majority of the elements would be vector graphics that have been made in Adobe Illustrator) to fit the standard screen sizes of a laptop, tablet and phone. 

# Project Concerns
My only main worries are about getting only a part of a banner to be clickable (especially if only JavaScript image mapping is used as I need three variations of the banner that will be slightly different design wise for responsibility), getting an animation implemented and working, and making sure the page navigation works automatically once the animation is complete. 

# Project Softwares
This will be a REACT component with the Next.js framework used, Adobe Illustrator will be used to make all the required vector graphics and either a combination of Adobe After Effects and Lottie or GSAP will be used for the animation component of this interactive feature.